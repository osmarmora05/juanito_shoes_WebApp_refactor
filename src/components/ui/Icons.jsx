...
export function CatalogueIcon({ className = "" }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`icon icon-tabler icons-tabler-outline icon-tabler-clipboard-list ${className}`}
    >
...
export function TicketRegistrationIcon({ className = "" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function OrdersIcon({ className = "" }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`icon icon-tabler icons-tabler-outline icon-tabler-shopping-bag ${className}`}
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export function StockIcon({ className = "" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function WorkersIcon({ className = "" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`icon icon-tabler icons-tabler-outline icon-tabler-users-group ${className}`}
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export function ManagementItemsIcon({ className = "" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function GeneralCompanyInformationIcon({ className = "" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`icon icon-tabler icons-tabler-outline icon-tabler-building ${className}`}
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      <path d="M3 21l18 0" />
      <path d="M9 8l1 0" />
...
export function ReportsIcon({ className = "" }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`icon icon-tabler icons-tabler-outline icon-tabler-report ${className}`}
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />

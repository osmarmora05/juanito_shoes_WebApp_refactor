...
export default function NavBar() {
  const [selectedOption, setSelectedOption] = useState("facturacion-nav");
      ...
      <div className="nav__pattern-logout">
        {showLogout && (
          <div className="nav__box-logout" ref={popupLogout}>
            <h6 className="nav__box-logout__name">Osmar Adrian Mora Cerna</h6>
            ...
            <div className="nav__box-logout__footer">
              <span onClick={() => setShowLogot(false)}>
                <LogoutIcon />
              </span>
